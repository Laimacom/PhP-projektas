...
<form method="POST">
    <label>Įveskite paieškos duomenis</label>
    <input type="text" name="filtras">
...
<div id="isfiltruota">
    ...
    echo "<th>Greitis (km/h)</th></tr>";
    if(!empty($automobiliai)) {
        //if (in_array('$_POST["filtras"]', $_SESSION["auto"]) == $_SESSION["auto"])
        if (preg_match("/[a-zA-Z]/",$_POST["filtras"]))
            foreach ($automobiliai as $a) {
                echo "<tr><td>" . $a['date'] . "</td>";
                echo "<td>" . $a['car_num'] . "</td>";
                echo "<td>" . $a['distance'] . "</td>";
