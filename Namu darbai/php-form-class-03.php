<?php
/**
Sukurti formą + php (viename faile - nereikia nurodyti formoje action), kuriame sukurti individualios veiklos mokesčių skaičiuoklę pagal https://www.tax.lt/skaiciuokles/individualios_veiklos_mokesciu_skaiciuokle (tik už 2017 metus).
 */
?>
    <form method="post">
        <div>
